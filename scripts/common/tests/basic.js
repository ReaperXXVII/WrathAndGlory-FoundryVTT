...
export class BasicRoll {
  ...
  {
    let html = await foundry.applications.handlebars.renderTemplate("systems/wrath-and-glory-revised/templates/chat/roll/basic-roll.hbs", {dice : this.dice, icons : this.icons})
    return html;
  }
